...
plt.savefig('deep-learning\\CNN\mnist_sample\\results\\tumor_sample_accuracy_plot.png')
...
plt.savefig('deep-learning\\CNN\\mnist_sample\\results\\tumor_sample_loss_plot.png')
